...
<h1>
  <img src="https://raw.githubusercontent.com/YunoHost/apps/main/logos/textarea.png" width="32px" alt="Logo of Textarea">
...
[![Version: 1.0.0~ynh1](https://img.shields.io/badge/Version-1.0.0~ynh1-rgb(18,138,11)?style=for-the-badge)](https://ci-apps.yunohost.org/ci/apps/textarea/)
...
🛠️ Upstream Textarea repository: <https://github.com/antonmedv/textarea>

Pull request are welcome and should target the [`testing` branch](https://github.com/YunoHost-Apps/textarea_ynh/tree/testing).

The `testing` branch can be tested using:
```
# fresh install:
sudo yunohost app install https://github.com/YunoHost-Apps/textarea_ynh/tree/testing

# upgrade an existing install:
sudo yunohost app upgrade textarea -u https://github.com/YunoHost-Apps/textarea_ynh/tree/testing
```
